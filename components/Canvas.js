                    ...
                    return {
                        ...
                        children: [
                            ...
                            ...(() => {
                                ...
                                return [
                                    ...icon.children.filter(path => context.selectedPath?.['data-name'] !== path['data-name']),
                                    ...(context.selectedPath ? [icon.children.find(c => c['data-name'] === context.selectedPath['data-name'])] : [])
                                ]
                            })().map(path => ({
                                ...path, 
