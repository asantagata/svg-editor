...
export default function CommandList(d) {
    return {
        class: 'command-list',
        id: 'command-list',
        children: specialPathTypes.has(context.selectedPath['data-type']) ? {class: 'command', key: 'special-command', children: SpecialCommandArguments(context.selectedPath['data-type'], context.selectedPath)} : d.flatMap((command, i) => [
